...
type disabledNetworkComponentsHolder struct {
...
// CreateDisabledNetworkComponents creates a new disabledNetworkComponentsHolder instance
func CreateDisabledNetworkComponents() (*disabledNetworkComponentsHolder, error) {
	netMessenger, err := NewDisabledMessenger()
	if err != nil {
		return nil, err
	}

	instance := &disabledNetworkComponentsHolder{
...
func (holder *disabledNetworkComponentsHolder) NetworkMessenger() p2p.Messenger {
	return holder.networkMessenger
}

// InputAntiFloodHandler returns the input antiflooder
func (holder *disabledNetworkComponentsHolder) InputAntiFloodHandler() factory.P2PAntifloodHandler {
	return holder.inputAntiFloodHandler
}

// OutputAntiFloodHandler returns the output antiflooder
func (holder *disabledNetworkComponentsHolder) OutputAntiFloodHandler() factory.P2PAntifloodHandler {
	return holder.outputAntiFloodHandler
}

// PubKeyCacher returns the public key cacher
func (holder *disabledNetworkComponentsHolder) PubKeyCacher() process.TimeCacher {
	return holder.pubKeyCacher
}

// PeerBlackListHandler returns the peer blacklist handler
func (holder *disabledNetworkComponentsHolder) PeerBlackListHandler() process.PeerBlackListCacher {
	return holder.peerBlackListHandler
}

// PeerHonestyHandler returns the peer honesty handler
func (holder *disabledNetworkComponentsHolder) PeerHonestyHandler() factory.PeerHonestyHandler {
	return holder.peerHonestyHandler
}

// PreferredPeersHolderHandler returns the preferred peers holder
func (holder *disabledNetworkComponentsHolder) PreferredPeersHolderHandler() factory.PreferredPeersHolderHandler {
	return holder.preferredPeersHolderHandler
}

// PeersRatingHandler returns the peers rating handler
func (holder *disabledNetworkComponentsHolder) PeersRatingHandler() p2p.PeersRatingHandler {
	return holder.peersRatingHandler
}

// PeersRatingMonitor returns the peers rating monitor
func (holder *disabledNetworkComponentsHolder) PeersRatingMonitor() p2p.PeersRatingMonitor {
	return holder.peersRatingMonitor
}

// FullArchiveNetworkMessenger returns the full archive network messenger
func (holder *disabledNetworkComponentsHolder) FullArchiveNetworkMessenger() p2p.Messenger {
...
func (holder *disabledNetworkComponentsHolder) FullArchivePreferredPeersHolderHandler() factory.PreferredPeersHolderHandler {
	return holder.fullArchivePreferredPeersHolderHandler
}

func (holder *disabledNetworkComponentsHolder) collectClosableComponents() {
...
func (holder *disabledNetworkComponentsHolder) Close() error {
	return holder.closeHandler.Close()
}

// IsInterfaceNil returns true if there is no value under the interface
func (holder *disabledNetworkComponentsHolder) IsInterfaceNil() bool {
	return holder == nil
}

// Create will do nothing
func (holder *disabledNetworkComponentsHolder) Create() error {
	return nil
}

// CheckSubcomponents will do nothing
func (holder *disabledNetworkComponentsHolder) CheckSubcomponents() error {
	return nil
}

// String will do nothing
func (holder *disabledNetworkComponentsHolder) String() string {
	return ""
}
